 ...
 * @method static Country getCountryByCode(string $code)
 * @method static Collection getCitiesByCode(string $code)
 * @method static Collection search(string $keyword, ?bool $strict = null, ?string $places = null, string $displayInName = null, string $parentId = null, bool $details = false, bool $tags = false)
